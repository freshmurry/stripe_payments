...
growth_hacking = Product.create(title: "Growth Hacking", 
	...
	description: %{<p>A <strong><em>growth hacker</em></strong> is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
            ...
            <hr>
            <p style="text-align: center"><strong>What You'll Learn</strong></p>
            <ul class="no-indent">
